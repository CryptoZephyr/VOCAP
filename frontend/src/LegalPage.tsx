      ...
      <article className="mx-auto max-w-3xl px-4 py-12 md:px-10 md:py-20">
        ...
        <div className="mt-12 grid gap-8">
          {isTerms ? <>
            ...
            <Section title="Mainnet boundary"><p>The Capability Trace keeps Mainnet evidence-only. A historical successful execution does not guarantee that a future write is safe, funded, compatible, or available.</p></Section>
